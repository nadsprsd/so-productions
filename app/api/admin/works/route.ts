...
function readData() {
  ...
  { 
    ...
    challenge: "Outdoor venue with severe wind conditions.", 
    solution: "Deployed K2 delay stacks.", 
    result: "Immaculate acoustics alignment.", 
    status: "published" 
  },
  { 
    id: "2", 
    title: "Corporate Tech Summit Gala", 
    type: "Corporate", 
    location: "Newark, NJ", 
    date: "November 2025", 
    tags: ["CORPORATE", "INDOOR"], 
    challenge: "High-profile corporate event with strict audio clarity demands.", 
    solution: "Distributed low-profile fill systems.", 
    result: "Perfect speech intelligibility across all zones.", 
    status: "published" 
  },
  { 
    id: "3", 
    ...
    date: "August 2025", 
    tags: ["SCHOOL", "THEATRE"], 
    challenge: "Challenging auditorium reverb layout constraints.", 
    solution: "Accurate directional coverage balancing.", 
    result: "Crystal-clear vocal production.", 
    status: "published" 
  }
];
